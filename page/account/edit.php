<?php
  ...
  require_once "engine/updatePost.php";
?>
<!doctype html>
<html lang="en">
        ...
        <div class="row">
                <div class="col-lg-7 create-form-outer">
                    ...
                    <div class="create-form">
                        <form action="engine/updatePost.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-xl-9 col-6 pb-md-4 pb-3">
                                    <label>Price</label>
                                    <input id="price" name="price" type="text" placeholder="Price" class="form-control" value="<?php echo $service[0]['price'];?>">
                                </div>
                                <!--
                                ...
                                <div class="col-md-7 pb-md-4 pb-3">
                                    ...
                                    <div class="btn-group w-100 pb-md-4">
                                        <input type="text" placeholder="category" class="filterbtn dropdown-toggle text-start category" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <input class="category_id hide" type="text">
                                    </div>
                                    <label>Choose subcategory</label>
                                    <div class="btn-group w-100">
                                        <input type="text" placeholder="subcategory" class="filterbtn dropdown-toggle text-start subcategory" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <input class="subcategory_id hide" type="text">
                                    </div>
                                </div>
                                <div class="col-xl-9 pb-md-4 pb-3">
                                    <label>Service name</label>
                                    <input name="item_name" id="service" type="text" placeholder="Enter Name" class="form-control" value="<?php echo $service[0]['item_name'];?>">
                                </div>
                                <div class="col-xl-9 pb-md-4 pb-3">
                                    <label>Description</label>
                                    <textarea name="description" id="desc" class="form-control" placeholder="Enter the description" style="color: #FFF;"><?php echo $service[0]['description'];?></textarea>
                                </div>
                                <div class="col-lg-12 pt-3 d-none d-lg-block ">
                                    <button name="send" class="btn btnlightblue m-auto m-md-0 d-table d-md-block">Create</button>
                                </div>
                            </div>
                        </from>
                    </div>
                ...
                <div class="col-lg-5 mt-5 mt-lg-0">
                    ...
                    <div class="aboutitem">
                        <div class="aboutitemImg"><img class="file-upload-image" src="<?php echo "assets/img/service/" . $service[0]['image'];?>" alt="img"></div>
                        <div class="bgdarkbluecolor aboutitemcnt">
                            <div class="itemtitlecode">
                                <h2 class="textgraycolor"><?php //category;?></h2>
                                <h3 class="textwhitecolor"><?php echo $service[0]['item_name'];?></h3>
                            </div>
                            <div class="itemtitlePrice">
                                <h2 class="textgraycolor">Price</h2>
                                <h3 class="textwhitecolor"><strong><?php echo $service[0]['price'];?></strong></h3>
